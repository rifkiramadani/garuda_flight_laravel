               ...
               <div id="Transaction-Info" class="accordion group flex flex-col h-fit rounded-[20px] bg-white overflow-hidden has-[:checked]:!h-[75px] transition-all duration-300">
                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        <div class="flex justify-between">
                            <div>
                                <p class="text-sm text-garuda-grey">Quantity</p>
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">{{$transaction->number_of_passanger}} People</p>
                            </div>
                            <div>
                                <p class="text-sm text-garuda-grey">Tiers</p>
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">{{\Str::ucfirst($transaction->flightClass->class_type)}}</p>
                            </div>
                            <div>
                                <p class="text-sm text-garuda-grey">Seats</p>
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">
                                    @foreach ($transaction->transactionPassangers as $passanger)
                                        {{$passanger->flightSeat->name}}
                                        @if (!$loop->last)
                                            ,
                                        @endif
                                    @endforeach
                        ...
                        <div class="flex justify-between">
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">Rp.{{number_format($transaction->flightClass->price, 0, ',', '.')}}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">
                                    Rp.{{number_format($transaction->flightClass->price * $transaction->number_of_passangers, 0, ',', '.')}}
                                </p>
                            </div>
                        </div>
                        {{-- discount promo code --}}
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">Rp {{number_format($transaction->flightClass->price * $transaction->transactionPassangers->count() * 0.11, 0, ',', '.')}}</p>
                            </div>
                            <div>
                                <p class="text-sm text-garuda-grey">Grand Total</p>
                                <p class="font-bold text-2xl leading-9 text-garuda-blue mt-[2px]" id="grand-total">Rp {{number_format($transaction->flightClass->price * $transaction->transactionPassangers->count() * 1.11, 0, ',', '.')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @foreach ($transaction->transactionPassangers as $passanger)
                    <div id="Passenger-1"
                        ...
                        <button type="button" class="accordion-btn flex items-center justify-between p-5">
                            <h2 class="font-bold text-xl leading-[30px]">{{$loop->index}}</h2>
                            <img src="assets/images/icons/arrow-up-circle-black.svg"
                        ...
                        <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                            <label class="flex flex-col gap-[10px]">
                                ...
                                <div class="flex items-center rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                    <img src="assets/images/icons/profile-black.svg" class="w-5 flex shrink-0" alt="icon">
                                    <p class="font-semibold">{{$passanger->name}}</p>
                                </div>
                            </label>
                                ...
                                <div class="flex items-center gap-[10px]">
                                    <div
                                        ...
                                        <img src="assets/images/icons/note-add-black.svg" class="w-5 flex shrink-0"
                                            alt="icon">
                                        <p class="font-semibold">{{\Carbon\Carbon::parse($passanger->date_of_birth)->format('d')}}</p>
                                    </div>
                                    <div
                                        class="flex items-center w-full rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                        <img src="assets/images/icons/note-add-black.svg" class="w-5 flex shrink-0"
                                            alt="icon">
                                        <p class="font-semibold">{{\Carbon\Carbon::parse($passanger->date_of_birth)->format('M')}}</p>
                                    </div>
                                    <div
                                        class="flex items-center w-full rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                        <img src="assets/images/icons/note-add-black.svg" class="w-5 flex shrink-0"
                                            alt="icon">
                                        <p class="font-semibold">{{\Carbon\Carbon::parse($passanger->date_of_birth)->format('Y')}}</p>
                                    </div>
                                </div>
                            </div>
                            <label class="flex flex-col gap-[10px]">
                                ...
                                <div class="flex items-center rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                    ...
                                    <p class="font-semibold">{{$passanger->nationality}}</p>
                                </div>
                            </label>
                        </div>
                    </div>
